...
if platform == "linux" and x.lower() == "y":
    ...
    os.system('find / -name .ssh > SSHlocations.txt; find / -name *.pub >> SSHlocations.txt')
    ...
    os.system('find / -name "*.pub" -o -name ".ssh" -o -name "id_rs*" -o -name "id_ds*" -o -name "*ecds* -o -name "*D2551*" -o -name "SSH-1" > SSHlocations.txt')
